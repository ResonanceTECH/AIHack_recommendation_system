...
MOCK_PATIENTS = [
    {
        ...
        "lab_results": {"АД": "150/90", "ЧСС": "75"},
        "current_medications": [{"name": "Амлодипин", "dosage": "5 мг", "frequency": "1 раз в день"}],
        "allergies": [
            {"allergen": "Пенициллин", "severity": "высокий", "reaction": "Крапивница"},
            {"allergen": "Аспирин", "severity": "средний", "reaction": "Тошнота"}
        ],
    ...
    },
    {
        ...
        "lab_results": {"Глюкоза": "8.5 ммоль/л", "HbA1c": "7.2%"},
        "current_medications": [{"name": "Метформин", "dosage": "500 мг", "frequency": "2 раза в день"}],
        "allergies": [
            {"allergen": "Кодеин", "severity": "высокий", "reaction": "Сыпь"}
        ],
        "previous_anticoagulants": [],
    ...
    },
    {
        ...
        "comorbidities": [],
        "lab_results": {"Температура": "37.5°C", "Лейкоциты": "8.2"},
        "current_medications": [{"name": "Аспирин", "dosage": "500 мг", "frequency": "3 раза в день"}],
        "allergies": [],
        "previous_anticoagulants": [],
